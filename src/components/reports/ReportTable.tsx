...
export function ReportTable({ title, periods, rows, periodCount, showChange = false }: ReportTableProps) {
  ...
  return (
    <div className="mb-6">
      ...
      >
        <table className="w-full border-collapse" style={{ minWidth: `${Math.max(400, displayPeriods.length * 120 + 240)}px` }}>
          <thead>
